/*
    ...
    For example, if you are given the date August 14, 2017, the method 
    should return as the day on that date. 
    ...
    Explanation:
        The day on August 17th was WEDNESDAY
*/
...
class Result {
    ...
    public static String findDay(int month, int day, int year) {
        ...
        //String out = ld.getDayOfWeek().name();
        //return out;
